(function () {
  ...
  var K = {uploadUrl: "http://oth.eve.mdt.qq.com:8080/analytics/upload", fileName: "beacon_release.js"};
  // 判断是否是 IE10 及以上
  if (!(0 < navigator.userAgent.indexOf("MSIE") && (0 < navigator.userAgent.indexOf("MSIE 6.0") || 0 < navigator.userAgent.indexOf("MSIE 7.0") ||
      ...
      for (var l = K.fileName, r = document.getElementsByTagName("script"), B = "", N = 0, F = 0; F < r.length; F++) {
          // 找到 K 中的 url 是某个已经被加载的 script 的 url
      ...
      if (N) {
          ...
          r = t.vc;
          if (l && r) {
              var x = t.openid, O = 0, S = function (b) {
                      function a(a, b, c, d) {
                      ...
                      var w = 0, r = b.document, v, t, z = /^(?:text|application)\/javascript/i,
                          B = /^(?:text|application)\/xml/i, x = "application/json", A = "text/html", D = /^\s*$/,
                          m = function (a) {
                              var f = q({}, a || {});
                              ...
                              p(f);
                              a = f.accepts[y];
                              var E = {}, l = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : b.location.protocol,
                                  k = m.settings.xhr(), n;
                      ...
                      return {ajax: m}
                  }(window), z = "", A = l || "", T = r || "", H = "", P = "", Q = "", U = navigator.language,
                  n = {id: "", start: 0, duration: 0}, w = (new Date).getTime(), p = {}, M = !0;
              l = {
              ...
              (function (b,
                  ...
                  var b = function (a) {
                      ...
                      this.each = function (a, c, d) {
                          if (null !== a) if (b && a.forEach === b) a.forEach(c, d); else if (a.length === +a.length) for (var f = 0, g = a.length; f < g && c.call(d, a[f], f, a) !== {}; f++) ; else for (f in a) if (a.hasOwnProperty(f) && c.call(d, a[f], f, a) === {}) break
                      };
              ...
              p.localStorage = {
                  add: function (b, a) {
                      ...
                      this.cookieList();
                      D("__BEACON_LOCAL", "", {expires: 365, path: "/", domain: location.hostname})
                  }, _addCookie: function (b) {
                      D("__BEACON_LOCAL", b, {expires: 365, path: "/", domain: location.hostname})
              ...
              J.prototype = {
                  getAjax: function (b, a, c, d, g) {
                      ...
                      })({url: this.url, type: "POST", param: JSON.stringify(c), success: d})
                  }, set: function (b, a, c) {
                      this.opts = b;
                      this.send(a,
                          c)
              ...
              (function (b) {
                  ...
                  BeaconComm.getCommon =
                      function (a) {
                          ...
                          for (var d = a.msg.length - 1; 0 < d; d--) {
                              var g = a.msg[d].data.pages.length, h = a.msg[d].data.events.length;
                  ...
                  BeaconComm.getCommonMsg =
                      function (a, b, d, e) {
                          return {
                              type: 2,
                              data: {id: a, start: b, status: d, duration: e || 0, pages: [], events: []}
                          }
                      };
                  BeaconComm.addSessionStart = function (a, b) {
                      e.add("lastSession", JSON.stringify({id: n.id, start: n.start}));
                  ...
                  BeaconComm.equal = function (a, b) {
                      ...
                      for (l = e.length; f < l; f++) {
                          ...
                          if ("object" == typeof a[e[f]] && "object" == typeof b[e[f]]) c = BeaconComm.equal(a[e[f]], b[e[f]]); else if (a[e[f]] !== b[e[f]]) return !1
                      }
                      return c
                  };
                  BeaconComm.addEvent = function (a, b, d) {
                      if (e.get("sessionMsg")) {
                          ...
                          if ("events" === b) if (x && a.params && (a.params.openid = x), a.params && (a.params.A102 = encodeURIComponent(window.location.href)), 0 != c.length) {
                              b = !1;
                              for (var h = 0; h < c.length; h++) if (BeaconComm.equal(c[h], a)) {
                                  b = !0;
                                  c[h].count += 1;
                                  c[h].start = a.start;
                                  break
                  ...
                  BeaconComm.addMsg =
                      function (a) {
                          ...
                          } else e.add("sessionMsg", JSON.stringify({msg: [a]}))
                      };
                  BeaconComm.cleanMsg = function () {
                      if (e.get("sessionMsg")) {
                          var a = JSON.parse(e.get("sessionMsg")), b = a.msg.length;
                  ...
                  BeaconComm.concatMsg = function (a) {
                      var b = e.get("sessionMsg"), d = a;
                      b && (d = JSON.parse(e.get("sessionMsg")), d.msg = d.msg ? d.msg.concat(a.msg) : a.msg);
                      e.add("sessionMsg", JSON.stringify(d))
                  }
              })(window);
              // 获取时间
              var e = p.localStorage, q = p.sessionStorage, I = {
                  timedif: void 0, state: 1, deviceId: 0, sessionId: 0, local: [], set: function () {
                      this.setDeviceId();
                      this.setSession();
                      this.setSessionTime();
                      this.setInitTime();
                      ...
                      if (e.get("deviceId")) this.deviceId = e.get("deviceId"); else {
                          var b = new p.Fingerprint, a = new p.Fingerprint({screen_resolution: !0});
                          b = b.get() + "" + a.get();
                      ...
                      if (0 < 32 - b.length) for (var a = 0, c = 32 - b.length; a < c; a++) b += "0";
                      ...
                      localStorage.__BEACON_sessionMsg || BeaconComm.addSessionStart(0,
                          2);
                      var c = JSON.parse(e.get("sessionMsg")), d = BeaconComm.getCommon(c),
              ...
              window.BeaconAction.onEvent = function (b, a, c) {
                  if (0 < arguments.length) try {
                      var d = {count: 1, start: (new Date).getTime()};
                      ...
                      }(c) ? d.params = c : d.params = {params: ""});
                      if (O) BeaconComm.addEvent(d, "events"); else {
                          ...
                          if (a) {
                              a = JSON.parse(a);
                              for (var g = 0,
                                       h = 0; h < a.length; h++) if (BeaconComm.equal(a[h], d)) {
                                  a[h].count += 1;
                                  a[h].start = d.start;
                                  g = 1;
                                  break
